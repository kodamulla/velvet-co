...
import UserData from "./UserData"; // UserData component එක import කරන්න
...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full z-50 px-4 md:px-8 py-3 md:py-5 flex items-center justify-between bg-background/80 md:bg-transparent backdrop-blur-md md:backdrop-blur-none transition-all">
      ...
      {/* 3. දකුණු පැත්තේ Buttons & UserData */}
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 w-full bg-white shadow-xl border-b border-secondary/50 md:hidden flex flex-col px-6 py-4 gap-3">
