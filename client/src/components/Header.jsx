  ...
  return (
    ...
    <header className="fixed top-0 w-full z-50 px-8 py-5 flex items-center justify-between">
      ...
      <div className="flex items-center gap-5">
        ...
        {/* Cart Icon Button */}
        <Link to="/cart" className="w-11 h-11 flex items-center justify-center bg-background rounded-[14px] shadow-sm border border-secondary hover:border-primary transition-colors text-text">
